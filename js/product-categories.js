...
(function () {
  ...
  var PRODUCTS = [
    ...
    { productKey:'birkenstock', productName:'Birkenstock / Sandalia Ergonómica', categoryId:'footwear_complete', aliases:['birkenstock','birken','sandalia birkenstock','arizona birkenstock','birkenstocks','birks'], misspellings:['birkensctock','birkensctocks','birckenstocks','birkenstosk','birkenstoks','birckenstosk','birckenstok','birkensock','birkenstotk','birckensock'], englishTerms:['birkenstock arizona','birkenstock boston'], spanishTerms:['sandalia birkenstock'], ecommerceTerms:['Birkenstock Arizona Soft Footbed','Birkenstock Boston'], commonSearchPhrases:['birkenstock precio','birken comprar'], riskOverrideFlags:[], customerHint:'', adminHint:'' },
